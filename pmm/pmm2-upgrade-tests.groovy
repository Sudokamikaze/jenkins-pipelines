library changelog: false, identifier: 'lib@PMM-7672', retriever: modernSCM([
    $class: 'GitSCMSource',
...
pipeline {
    ...
    parameters {
        string(
            ...
            name: 'GIT_BRANCH')
        choice(
            choices: ['2.3.0', '2.4.0', '2.5.0', '2.6.0', '2.6.1', '2.7.0', '2.8.0', '2.9.0', '2.9.1', '2.10.0', '2.10.1', '2.11.0', '2.11.1', '2.12.0', '2.13.0', '2.14.0', '2.15.0'],
